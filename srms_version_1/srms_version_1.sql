...
;
--
-- Current Database: `srms_version_1`
--
...
(
    ...
    'Bamusubire James',
    '2021-BSIT-10101',
    'james.bamusubire@stud.umu.ac.ug',
    'Male',
    '1999-10-01',
    2,
    '2024-11-06 15:55:13',
...
(
    8,
    'Amanyire Josua Muhinda',
    '2023-D011-10121',
    'amanyire.joshua@stud.umu.ac.ug',
    'Male',
    '2000-09-19',
    1,
    '2024-11-06 17:28:02',
...
(
    ...
    'Namukasa Gloria',
    '2023-D011-11111',
    'gloria.namukasa@stud.umu.ac.ug',
    'Female',
    '2000-01-27',
    1,
    '2024-11-07 11:39:43',
...
(
    ...
    'Nakalema Mildred',
    '2023-D011-10324',
    'nakalema.mildred@stud.umu.ac.ug',
    'Female',
    '2000-12-25',
    1,
    '2024-11-07 18:12:34',
...
(
    ...
    'Rukundo Francis',
    '2023-BSIT-10010',
    'rukundo.francis@stud.umu.ac.ug',
    'Female',
    '',
    11,
    '2024-11-12 08:46:49',
...
(
    ...
    'Ankunda Rebecca',
    '2023-B021-12180',
    'ankunda.rebecca@stud.umu.ac.ug',
    'Female',
    '2003-03-19',
    16,
    '2024-11-17 17:23:40',
...
(
    16,
    'Nalubega Maria Gonzaga',
    '2023-BBAM-10205',
    'nalubega.maria@stud.umu.ac.ug',
    'Female',
    '1999-02-27',
    16,
    '2024-12-18 18:11:38',
...
VALUES (
  ...
  (
    2,
    'Mugabi Ivan',
    'b91e5e5a62bf7fa4a5cafb77d6f36f0c',
    'ivanm@umu.ac.ug',
    'Administrator',
    '+256-701453678',
    '2024-11-12 11:00:45'
...
VALUES (
  ...
  (32, 1, 1, 1, '2024-11-07 08:58:36', NULL),
  (33, 2, 1, 1, '2024-11-07 08:58:51', NULL),
  (34, 2, 15, 1, '2024-11-07 11:41:55', NULL),
  (35, 2, 14, 1, '2024-11-07 15:15:22', NULL),
  (36, 14, 15, 1, '2024-11-11 13:26:33', NULL),
  (
    37,
    16,
    20,
...
VALUES (
    2,
    'Notice regarding result Delearation',
...
(
    3,
    'Test Notice',
    'This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  This is for testing purposes only.  ',
    '2024-05-02 14:48:32'
  ),
(
    7,
    'management',
    'management meeting starts at 2pm',
    '2025-02-25 14:02:46'
  );
...
(2, 'Lecturer', 'Business', '2024-11-06 14:51:43'),
(3, 'Dean', 'Science', '2024-11-06 14:51:43'),
(
    4,
    'Head of Department',
    'Law',
...
(7, 'Counselor', 'Humanities', '2024-11-06 14:51:43'),
(8, 'Registrar', 'Business', '2024-11-06 14:51:43'),
(9, 'Student', 'Law', '2024-11-06 14:51:43'),
(
    10,
    'Research Assistant',
    'Science',
...
;
-- Dump completed on 2025-04-03 10:26:50